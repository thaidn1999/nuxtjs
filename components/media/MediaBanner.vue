<template>
  <NuxtLink :to="`${item.media_type || type}/${item.id}`" class="block mb-6">
    <div
      class="relative bg-black aspect-[1/1] md:aspect-[3/2] lg:aspect-[25/9] aspect-1-1 md:aspect-3-2 lg:aspect-25-9"
    >
      ...
      <div
        class="absolute bottom-0 left-0 top-0 right-0 flex flex-col justify-center p-10 bg-gradient-to-t from-black via-black to-transparent lg:px-24 lg:w-2/3 lg:bg-gradient-to-r"
      >
        <div>
          ...
          <p
            class="mt-2 opacity-80 leading-relaxed overflow-hidden text-xs md:text-base line-clamp-3"
          >
            {{ item.overview }}
          </p>
        </div>
